       ...
       <v-row align="start" justify="center">
        ...
        >
          <template v-slot:item.keys="{ item }">
            <v-btn v-for="button in item.keys" :key="button.id" rounded x-small color="primary"> {{ button.key }} </v-btn>
          </template>
          <template v-slot:item.mouse_keys="{ item }">
            <v-btn v-for="button in item.mouse_keys" :key="button.id" rounded x-small color="primary"> {{ button.mouse_key }} </v-btn>
          </template>
        </v-data-table>
      </v-row>
    </v-container>
